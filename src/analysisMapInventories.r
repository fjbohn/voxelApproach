...
plot(census$X[sortiert],census$Y[sortiert],cex=(census$dbh[sortiert]/max(census$dbh[sortiert])),pch=16,col=paste0(openColours("jet",100)[census$agb[sortiert]/max(census$agb[sortiert])*100],"ff"),xlab="x[m]",ylab="y[m]")
